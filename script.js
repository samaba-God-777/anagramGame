...
const SIDEBAR_STRUCTURE = [
  ...
  { type: "section", icon: "📚", label: "Grammar", children: [
    { type: "group", icon: "📖", label: "English Tenses", href: "present-simple.html", isTense: true, forms: ["Affirmative","Negative","Questions"] },
    { type: "group", icon: "🔗", label: "Clauses", href: "clauses.html", children: [
      { label: "Noun Clauses", href: "noun-clauses.html" },
      { label: "Adjective Clauses", href: "adjective-clauses.html" },
      { label: "Adverb Clauses", href: "adverb-clauses.html" },
    ]},
    { type: "link", icon: "📍", label: "Prepositions", href: "prepositions.html" },
    { type: "link", icon: "🔗", label: "Conjunctions", href: "conjunctions.html" },
    { type: "link", icon: "📏", label: "Adjective Positions", href: "adjective-positions.html" },
    { type: "link", icon: "📍", label: "Adverb Positions", href: "adverb-positions.html" },
    { type: "link", icon: "💬", label: "Phrasal Verbs", href: "phrasal-verbs.html" },
    { type: "link", icon: "🎭", label: "Idiomatic Expressions", href: "idiomatic-expressions.html" },
  ]},
  { type: "section", icon: "🎮", label: "Games", children: [
    { type: "link", icon: "🔤", label: "Anagram Game", href: "game-anagram.html" },
    { type: "link", icon: "📝", label: "Sentence Unscramble", href: "game-unscramble.html" },
    { type: "link", icon: "🔍", label: "Error Correction", href: "game-error-correction.html" },
    { type: "link", icon: "⏰", label: "Verb Tense Challenge", href: "game-verb-tense.html" },
    { type: "link", icon: "📏", label: "Word Order Challenge", href: "game-word-order.html" },
    { type: "link", icon: "📍", label: "Preposition Challenge", href: "game-preposition.html" },
    { type: "link", icon: "📏", label: "Adjective Order", href: "game-adjective-order.html" },
    { type: "link", icon: "📍", label: "Adverb Placement", href: "game-adverb-placement.html" },
    { type: "link", icon: "🔗", label: "Clause Identification", href: "game-clause-identification.html" },
  ]},
  { type: "link", icon: "🎯", label: "Daily Challenge", href: "daily-challenge.html", divider: true },
];
